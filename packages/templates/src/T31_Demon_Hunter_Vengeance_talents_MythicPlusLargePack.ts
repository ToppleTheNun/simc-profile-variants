...
export const T31_Demon_Hunter_Vengeance_talents_MythicPlusLargePack = dedent` 
  ptr=1
  ...
  head=flaring_cowl,id=193494,bonus_id=9500/9498/9405/8960/6935,gem_id=192919
  neck=torc_of_passed_time,id=201759,bonus_id=9500/9498/9405/8782,gem_id=192919/192919/192919,crafted_stats=36/32
  shoulder=screaming_torchfiends_horned_memento,id=207261,bonus_id=7187/1520
  back=screaming_torchfiends_shawl,id=207258,bonus_id=7187/1520
  chest=screaming_torchfiends_binding,id=207266,bonus_id=7187/1520,enchant_id=6625
  wrist=verdant_sanctuary_bands,id=210206,bonus_id=7187/1520,gem_id=192919
  hands=screaming_torchfiends_grasp,id=207264,bonus_id=7187/1520
  waist=screaming_torchfiends_clasp,id=207260,bonus_id=7187/1520,gem_id=192985
  legs=screaming_torchfiends_blazewraps,id=207262,bonus_id=7187/1520,enchant=frosted_armor_kit_3
  ...
  off_hand=gholak_the_final_conflagration,id=207786,bonus_id=7187/1520,enchant=wafting_devotion_3
  
  
  
  demonhunter="CA / Elysian Decree"
  spec=vengeance
  level=70
  race=night_elf
  timeofday=day
  role=tank
  position=front
  talents=BUkAAAAAAAAAAAAAAAAAAAAAAAAISSiQCSSQISJJkolIRiESSKJJtkESQAAAAAJJB
  ...
  demonhunter="The Hunt / Elysian Decree"
  spec=vengeance
  level=70
  race=night_elf
  timeofday=day
  role=tank
  position=front
  talents=BUkAAAAAAAAAAAAAAAAAAAAAAAAiIJJCJIJBhIlkQiWiEJSIJpkk0kkWSQAAAAAJJA
