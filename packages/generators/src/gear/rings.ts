...
import { ringEnchants } from "../modifiers/enchants.js";

export const gear = ringEnchants(
  defineGear([
    {
      name: "Ring-bound",
      options:
        "ringbound_hourglass,id=193000,bonus_id=9498/9500/9405/8780,gem_id=192922,crafted_stats=36/32,ilevel=522",
      slot: "finger1",
      uniqueId: 193000,
    },
    {
      name: "Titanic",
      options:
        "signet_of_titanic_insight,id=192999,bonus_id=9498/9500/9405/8780,gem_id=192922,crafted_stats=36/32,ilevel=522",
      slot: "finger1",
      uniqueId: 192999,
    },
    {
    ...
    },
    {
      name: "Diurna",
      options:
        "seal_of_filial_duty,id=195526,bonus_id=10359/1498/6935,gem_id=192922",
      slot: "finger1",
      uniqueId: 204398,
    },
  ]),
